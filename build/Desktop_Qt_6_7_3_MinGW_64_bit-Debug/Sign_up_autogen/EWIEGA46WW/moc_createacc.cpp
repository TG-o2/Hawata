...
struct qt_meta_stringdata_CLASSCreateAccENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCreateAccENDCLASS = QtMocHelpers::stringData(
    "CreateAcc",
    "on_cancel_clicked",
    "",
    "on_signup_clicked"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCreateAccENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CreateAcc::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCreateAccENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCreateAccENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCreateAccENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *CreateAcc::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCreateAccENDCLASS.stringdata0))
